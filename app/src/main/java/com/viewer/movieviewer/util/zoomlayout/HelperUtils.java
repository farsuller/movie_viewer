package com.viewer.movieviewer.util.zoomlayout;
...
public class HelperUtils {
     ...
     */
    public static Bitmap getBitmapFromView(android.view.View view, int leftDiffrence,
     ...
     */
    public static Rect locateViewWithZoom(android.view.View view, float realZoom) {
        Rect loc = new Rect();
     ...
     */
    public static Rect locateView(android.view.View view) {
        Rect loc = new Rect();
        int[] location = new int[2];
        if (view == null) {
            return loc;
